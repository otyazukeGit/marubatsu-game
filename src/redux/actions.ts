...
export type SetResultType = {type: 'setResult', msg: string, winner: 'USER'|'CPU'|'DRAW'}
...
export type InputValidateSignUp = {type: 'inputValidateSignUp', item:'top'|'userName'|'email'|'password'|'confirmPassword', msg:string}
export type InputValidateSignIn = {type: 'inputValidateSignIn', item:'top'|'email'|'password', msg:string}

export type ActionType = SelectItemType | SetResultType | SignInType | SignOutType | RetryGameType | CloseModalType | InputValidateSignUp | InputValidateSignIn
...
export const setResult = (msg: string, winner: 'USER'|'CPU'|'DRAW'):SetResultType => {
...
export const inputValidateSignUp = (item:'top'|'userName'|'email'|'password'|'confirmPassword', msg:string):InputValidateSignUp => {
	return {type: 'inputValidateSignUp', item:item, msg:msg}
}
export const inputValidateSignIn = (item:'top'|'email'|'password', msg:string):InputValidateSignIn => {
